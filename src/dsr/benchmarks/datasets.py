...
def get_task_suite(name: str, num_samples: int = 100) -> List[SymbolicTask]:
    ...
    if name == "pmlb_nguyen_subset":
        nguyen_names = ["nguyen_1", "nguyen_2", "nguyen_3", "nguyen_4"]
        return [get_pmlb_task(n, num_samples) for n in nguyen_names]
...
def get_task_by_name(task_name: str, num_samples: int = 100) -> SymbolicTask:
    ...
    if task_name.startswith("feynman_") or task_name.startswith("nguyen_"):
        try:
